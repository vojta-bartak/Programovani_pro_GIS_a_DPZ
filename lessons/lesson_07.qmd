...
**Úkoly:** 1. Načíst soubor 2. Vypsat všechna města s populací \> 200
000 3. Spočítat celkovou populaci všech měst 4. Najít město s nejvyšší
populací
...
**Napište program, který:** 1. Načte data 2. Spočítá průměrnou teplotu
3. Najde den s nejvyšší teplotou 4. Uloží výsledky do
`vysledky_teploty.txt`
...
**Napište program, který:** 1. Pro každý okres vypočítá hustotu obyvatel
(populace/rozloha) 2. Použije `bubble_sort()` z `math_utils` pro
seřazení okresů podle hustoty 3. Uloží výsledky do `hustota_okresu.txt`:
